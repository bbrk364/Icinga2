...
private:
	...
	void TypesCompletionHandler(ExceptionPtr eptr, const std::vector<ApiType::Ptr>& types, bool forward);
	void ObjectsCompletionHandler(ExceptionPtr eptr, const std::vector<ApiObject::Ptr>& objects, bool forward);
	void ObjectDetailsCompletionHandler(ExceptionPtr eptr, const std::vector<ApiObject::Ptr>& objects, bool forward);

...
public:
	...
	typedef boost::function<void(ExceptionPtr, const std::vector<ApiType::Ptr>&)> TypesCompletionCallback;
	void GetTypes(const TypesCompletionCallback& callback) const;

	typedef boost::function<void(ExceptionPtr, const std::vector<ApiObject::Ptr>&)> ObjectsCompletionCallback;
	...
	typedef boost::function<void(ExceptionPtr, const Value&)> ExecuteScriptCompletionCallback;
	...
	typedef boost::function<void(ExceptionPtr, const Array::Ptr&)> AutocompleteScriptCompletionCallback;
